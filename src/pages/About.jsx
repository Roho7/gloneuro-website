      ...
      <div className="page-container">
        <div className=" flex max-md:flex-col  gap-0 rounded-xl overflow-clip">
          ...
          <p className="p-4 text-xl glass bg-base-500 text-egg-100 ">
            ...
            We are an innovative organization founded by Neuroscience think
            tanks, researchers, and educationists who have been associated with
            the world’s key Neuroscience organizations, including the
            multi-lateral bodies. Our aim is to spread brain awareness,
            knowledge, and enhance the quality of brain health through public
            engagement, along with updating neuroscience students and scientists
            with opportunities, latest research, and upskilling. We follow an
            enthusiastic volunteer-based ecosystem approach to bring positive
            changes in the career of all interested in Neurosciences. Our team
            wishes to be known for easy-to-understand brain health facts and
            informative works.
          </p>
        </div>
        <br />
        <div className="m-4 p-4 glass bg-salmon-300 rounded-xl text-egg-100">
          ...
          <ul className=" m-4 list-disc">
            <li>
              To make people aware of the importance of maintaining cognitive
              and mental health and daily activities that may help them in the
              process.
            </li>
            <li>
            ...
            <li>
              To help students of different backgrounds gain conceptual
              knowledge in the field of neuroscience.
            </li>
            <li>
            ...
            <li>
              ...
              short-term research opportunities that ensure the successful
              pursuit of future career goals in academia, medicine, the health
            ...
            <li>
              To organize interesting competitions among students helping them
              to gain interest and upskill their abilities to pursue a career in
              neuroscience.
            </li>
            <li>
              To promote neuroscience at the school level and make students
              learn about the intriguing opportunities available in this field.
            </li>
            <li>
              To develop an interactive platform where researchers and
              physicians can find appropriate content and network for the
